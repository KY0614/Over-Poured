...
HotCoffee::HotCoffee(const std::string objId, const float width,
	const float height, const float depth, Player& player) :
	StageObject(objId, width, height, depth, player)
{
}

void HotCoffee::ItemCarry(void)
{
...
void HotCoffee::ItemPlaced(VECTOR pos)
{
    auto& ins = InputManager::GetInstance();
...
void HotCoffee::UpdatePlaced(void)
{
}
